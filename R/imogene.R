...
#'\itemize{
#'\item{\code{\link[imogene]{AG_gene_list}}:}{ Angiogenesis signature genes}
#'\item{\code{\link[imogene]{EMT_gene_list}}:}{ EMT signature genes}
#'\item{\code{\link[imogene]{icp_gene_list}}:}{ Default list of immune checkpoints}
#'\item{\code{\link[imogene]{sample_immune_cell_fraction_data}}:}{ Sample immune cell fraction data}
#'\item{\code{\link[imogene]{sample_Leukocyte_fraction_data}}:}{ Sample Leukocyte fraction data}
#'\item{\code{\link[imogene]{sample_mRNA_data}}:}{ Sample expression data}
#'\item{\code{\link[imogene]{TCGA_Leukocyte_fraction}}:}{ Leukocyte fraction for TCGA data}
#'\item{\code{\link[imogene]{TCGA_IMCell_fraction}}:}{ Immune cell type fractions for TCGA data}
#'\item{\code{\link[imogene]{TCGA_TMB}}:}{ Tumor mutation burden for TCGA data}
#'\item{\code{\link[imogene]{TCGA_immune_features_list}}:}{ Default immune features for TCGA data}
#'\item{\code{\link[imogene]{TCGA_disease_list}}:}{ TCGA abbreviated disease names}
#
#'
#'}
#' @docType package

---
title: "How to use imogene"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{imogene-vignette}
...
imogene (Immuno-Oncology GENE expression associations)

## Introduction

Imogene calculates statistical synergy scores based on gene expression profiles in multi-sample data to quantify combinatorial effects of oncogenes and immune checkpoints on immune related phenotype.

## Example use of TCGA data

imogene uses `curatedTCGAData` API functions to access RNASeq2GeneNorm expressions.
